...
**MAUI Project Root:** `c:\Users\Admin\Downloads\bareiron viewer  DONTDELETE\MauiApp bareiron viewer\`
...
**File:** `c:\Users\Admin\Downloads\bareiron viewer  DONTDELETE\MauiApp bareiron viewer\Services\MeshParser.cs`
**Line:** 149
**Current Code:**
```csharp
...
**File:** `c:\Users\Admin\Downloads\bareiron viewer  DONTDELETE\MauiApp bareiron viewer\Services\BareIronTextureDecoder.cs`
**Line:** 69
**Current Code:**
```csharp
...
**File:** `c:\Users\Admin\Downloads\bareiron viewer  DONTDELETE\MauiApp bareiron viewer\Components\Pages\Home.razor`
**Lines:** 982-1002
...
**Copy this to:** `c:\Users\Admin\Downloads\bareiron viewer  DONTDELETE\MauiApp bareiron viewer\Services\BigArrayPool.cs`

**Add namespace:** `namespace MauiApp_bareiron_viewer.Services`
...
**File to create:** `c:\Users\Admin\Downloads\bareiron viewer  DONTDELETE\MauiApp bareiron viewer\Services\BigArrayPool.cs`

**Action:** Copy the exact code from reference above (lines 241-252 in this document)
- Change namespace from `AssetStudio` to `MauiApp_bareiron_viewer.Services`
